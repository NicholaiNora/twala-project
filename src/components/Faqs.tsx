            ...
            >
              ...
              >
                <div className="flex flex-col w-[88%] mt-8 transition-all duration-200 hover:border-l-[1px] hover:border-l-[#7a13ce]">
                  ...
                  >
                    Twala is an app that allows you or your customers to easily
                    sign legally binding documents (e.g. lease agreement,
                    contract of employment, sales contact, and more) online
                    using any laptop or smartphone. Twala can also be used to
                    issue tamper-proof digital credentials (e.g. digital
                    diploma, certificate of employment, training certificates).
                  </p>
                </div>
              </div>
            </div>
